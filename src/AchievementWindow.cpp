...
AchievementWindow::AchievementWindow(void)
	:	DWindow(BRect(100,500,100,400),B_TRANSLATE("Achievements"),
...

{
	...
	BLayoutBuilder::Group<>(top, B_VERTICAL, 0)
		...
		.AddGroup(B_VERTICAL, 0)
			...
			.Add(labelList[3][0] = new BStringView("gen1Label", B_TRANSLATE("Basic Training - Win a game")))
			.Add(labelList[3][1] = new BStringView("gen2Label", B_TRANSLATE("Active Duty - Win 5 games")))
			.AddStrut(B_USE_DEFAULT_SPACING)
			//Beginner achivements
			.Add(begTitle = new BStringView("begTitle", B_TRANSLATE("Difficulty: Beginner")))
			.Add(labelList[0][0] = new BStringView("beg1Label", B_TRANSLATE("Recruit - Win within 100 seconds")))
			.Add(labelList[0][1] = new BStringView("beg2Label",  B_TRANSLATE("Bomb Buster - Win within 50 seconds")))
			.AddStrut(B_USE_DEFAULT_SPACING)
			//Intermediate achievements
			.Add(intTitle = new BStringView("intTitle", B_TRANSLATE("Difficulty: Intermediate")))
			.Add(labelList[1][0] = new BStringView("int1Label", B_TRANSLATE("Officer - Win within 100 seconds")))
			.Add(labelList[1][1] = new BStringView("int2Label", B_TRANSLATE("Master Defuser - Win within 50 seconds")))
			.AddStrut(B_USE_DEFAULT_SPACING)
			//Expert achievements
			.Add(expTitle = new BStringView("expTitle", B_TRANSLATE("Difficulty: Expert")))
			.Add(labelList[2][0] = new BStringView("exp1Label", B_TRANSLATE("Commando - Win within 100 seconds")))
			.Add(labelList[2][1] = new BStringView("exp1Label", B_TRANSLATE("Mine Zone Veteran - Win within 50 seconds")))
		.End()
