				...
				| B_CLOSE_ON_ESCAPE)
{
	...
	HelpText *howto = new HelpText("howto", B_TRANSLATE(
		"The goal of the game is to flag all mines that are hidden on the "
	...
	HelpText *text1 = new HelpText("text1", B_TRANSLATE(
		"Reveal what's under a tile. If it's a mine, the game is over!"));

	BStringView *header2 = new BStringView("header2", B_TRANSLATE("Right click:"));
	HelpText *text2 = new HelpText("text2", B_TRANSLATE(
		"Flag a tile as a mine, set a question mark if you're unsure, or unmark "
		"an already flagged tile."));

	BStringView *header3 = new BStringView("header3", B_TRANSLATE(
		"Middle click (or ALT + left click):"));
	HelpText *text3 = new HelpText("text3", B_TRANSLATE(
		"A sonar ping reveals all mines in a 3x3 tile area without the danger "
		"of setting them off. It comes with a 20 second cost added to your time."));

	BStringView *header4 = new BStringView("header4", B_TRANSLATE(
		"Clicking with both buttons (or SHIFT + left click):"));
	header4->SetExplicitMinSize(BSize(450, B_SIZE_UNSET));
	HelpText *text4 = new HelpText("text4", B_TRANSLATE(
		"If the tile is a number and the appropriate number of mines around it "
